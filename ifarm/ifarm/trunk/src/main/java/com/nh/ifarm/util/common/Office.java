...
public class Office {
    ...
    private static final String KEY_CELL_DB_RELATION3 = "Cell.Db.Relation3";
    ...
    public PageData checkExcelDataVaild(Workbook wb, ResourceBundle conf, String upload_file_type) {
        ...
        try{
            ...
            }else if(upload_file_type.equals("3") || upload_file_type.equals("4")){
                confCellDbRelation = conf.getString(KEY_CELL_DB_RELATION);
            }else{
                    ...
                    try{
                        switch (lookupValue) {
                            ...
                            case "INT":
                                ...
                                break;
                            case "DOUBLE":
                                String string = String.valueOf(pdData.getString(iPdKey));
                                if(string.equals("")){
                                    int o =1;
                                }
                                pdData.put(iPdKey, Double.valueOf((string.equals("")? "0" : string)));
                                break;
                        }
                    }catch(Exception e){
                        e.printStackTrace();
