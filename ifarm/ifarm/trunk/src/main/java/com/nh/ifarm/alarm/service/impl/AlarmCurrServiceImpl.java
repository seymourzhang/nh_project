...
public class AlarmCurrServiceImpl implements AlarmCurrService {
	...
	public List<PageData> selectAll(PageData pd) throws Exception {
		...
		return (List<PageData>) dao.findForList("AlarmCurrMapper.selectAll", pd);
	}
	...
	@Override
	public int updateAlarm2(PageData pd) throws Exception{
		return (Integer) dao.update("AlarmCurrMapper.updateAlarm2", pd);
	}
	
	@Override
	public int updateStockChangeRemind(PageData pd) throws Exception{
		return (Integer) dao.update("AlarmCurrMapper.updateStockChangeRemind", pd);
	}
