package com.nh.ifarm.system.entity;
...
public class SDMenu implements Serializable{
	...
	private String SHOW_HOUSE_TYPE; //栋舍类型对应的显示菜单，使用符号"|"分割
	...
	public String getSHOW_HOUSE_TYPE() {
		return SHOW_HOUSE_TYPE;
	}

	public void setSHOW_HOUSE_TYPE(String SHOW_HOUSE_TYPE) {
		this.SHOW_HOUSE_TYPE = SHOW_HOUSE_TYPE;
	}
