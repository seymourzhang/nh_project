package com.nh.ifarm.util.service;
...
public interface OrganService {
	List<PageData> getOrgLevelList(PageData pd) throws Exception;
	...
	List<PageData> getFarmListByFarmName(PageData pd) throws Exception;
}
