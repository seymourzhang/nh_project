...
<div class="header navbar navbar-inverse navbar-fixed-top" style="height: 61px;z-index: 1;">
	...
	<div class="navbar-inner" style="height: 50px;z-index: 3;">
		<div class="container-fluid">
			<a class="brand" href="#" style="width: 320px;"> <img src="<%=path%>/framework/image/logo.png" alt="logo" style="padding-left: 13px;float: left;height: 40px;width: 40px;margin-top: -4px;" />
			<div style="font-size: 24px;color: #FFFFFF;padding-left: 8px;padding-top: 5px;float: left;font-weight:bold;" id="system_name"></div>
...
//                                                    document.getElementById("day" + (i+1) + "T").innerHTML = wd[i].tempLow + " - " + wd[i].tempHigh + "&nbsp;&nbsp;" + wd[i].windLevel;
				...
				<li class="dropdown" id="header_remind_bar">
					...
					<ul class="dropdown-menu" style="margin-top:4px;width: 300px; " id="head_msg_remind_CurrList">
					</ul>
				</li>
				...
				<a href="#" class="dropdown-toggle" data-toggle="dropdown" style="margin-top:4px; "> <img src="<%=path%>/framework/image/warn.png" style="width: 18px;height: 18px;"> <span class="badge"  style="margin-top:6px;" id="head_msg_currCount"></span>
					...
					<ul class="dropdown-menu " style="margin-top:6px;width: 300px; " id="head_msg_CurrList">
...
<!-- END HEADER -->
<script type="text/javascript" src="<%=path%>/framework/inc/js/system.js"></script>
<!--引入属于此页面的js -->
