...
<div class ='font s32 white'
    ...
    <p style="height:85px; line-height:85px; width:100%; overflow:hidden; " id = "topLogin_system_name">
    </p>
</div>
<%--顶部区域（系统用）--%>
    ...
    <%--<div class="container-fluid">--%>
        <div class="row">
            ...
            <div class="col-lg-7">
                ...
                <span class="font s24 white bold" id = "topSystem_system_name" style="vertical-align:middle;">
                </span>
            </div>
...
<script>
    var region_top = {
        ...
        setStyle: function (style){
            system.setTitle();
            if(style == "login"){
                document.getElementById("topLogin_system_name").innerHTML = "&nbsp;&nbsp;&nbsp;&nbsp;" + document.title + "&nbsp;&nbsp;<%= systemVersion%>";
                document.getElementById("topLogin").style.display = "block";
                document.getElementById("topSystem").style.display = "none";
            } else{
                document.getElementById("topSystem_system_name").innerHTML = document.title;
