            ...
            <div class="tabbable tabbable-custom boxless">
                ...
                <div class="tab-content" style="border:none;background:#e7e5e5;padding-top: 0px;">
                    <div class="tab-pane active" id="tab_1">
                        ...
                        <iframe id="iframe_tab_1" name="systemUseInfoForm" width="99.8%" height="720" frameborder="no" allowtransparency="yes" src="">
                        </iframe>
                    </div>


                    <div class="tab-pane" id="tab_2">
                        <iframe id="iframe_tab_2" name="userStatForm" width="99.8%" height="720" frameborder="no" allowtransparency="yes" src="">
                        </iframe>
                    </div>
                </div>
...
<script type="text/javascript" src="<%=path%>/modules/analyze/js/systemStatReport.js"></script>
<!-- 确认窗口 -->
