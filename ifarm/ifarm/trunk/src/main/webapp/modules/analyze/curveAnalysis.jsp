...
<%--<div id="page-content" class="clearfix" style="padding-top: 0px;background:#e7e5e5;">--%>
    <%--<div class="row-fluid">--%>
        <%--<div class="span12">--%>
            <%--<div class="row-fluid">--%>
                ...
                <%--<div class="span12" id = "tab" style="margin-left: 0px;height: 10px;display: none;">--%>
                    <%--<ul class="nav nav-pills row-fluid" style="margin-bottom: 0px; " id = "uiTab">--%>
                        ...
                        <%--</li>--%>
                        <%--<li class="${pd.tabs[7]} " id="li7" style="text-align: center;width:20%;background-color: #BFBFBF;  border-right: 1px solid #E0DFDF;display: none;" >--%>
                            <%--<a href="#tab_8"  data-toggle="tab">育成</a>--%>
                        <%--</li>--%>
                        <%--<li class="${pd.tabs[8]} " id="li8" style="text-align: center;width:20%;background-color: #BFBFBF;  border-right: 1px solid #E0DFDF;display: none;" >--%>
                            <%--<a href="#tab_9"  data-toggle="tab">产蛋</a>--%>
                        <%--</li>--%>
                        <%--<li class="${pd.tabs[9]} " id="li9" style="text-align: center;width:20%;background-color: #BFBFBF;  border-right: 1px solid #E0DFDF;display: none;" >--%>
                            <%--<a href="#tab_10"  data-toggle="tab">肉鸡</a>--%>
                        <%--</li>--%>

                        <%--&lt;%&ndash;<li class="${pd.tabs[4]} " style="text-align: center;width:20%;background-color: #BFBFBF;  border-right: 1px solid #E0DFDF;" >&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<a href="#tab_5"  data-toggle="tab">报警</a>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;</li>&ndash;%&gt;--%>
                    <%--</ul>--%>
                <%--</div>--%>
            <%--</div>--%>
            ...
            <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
            <%--&lt;%&ndash;<iframe id="iframe_tab_1" name="inStockForm" width="99.8%" height="720" frameborder="no" allowtransparency="yes" src="">&ndash;%&gt;--%>
            <%--&lt;%&ndash;</iframe>&ndash;%&gt;--%>
            ...
            <%--<div class="row-fluid" style="background:#e7e5e5;">--%>
                <%--<div class="span12">--%>
                    <%--<div class="tab-content" style="border:none;">--%>
                        <%--<div class="tab-pane ${pd.tabs[0]}" id="tab_1" style="display: none;">--%>
                            <%--&lt;%&ndash;<iframe id="inStockForm" name="inStockForm" width="100%" height="700" frameborder="no" allowtransparency="yes" src="<%=urlPre%>/inStockForm.cpt<%=urlParamUserId%>${pd.user_id} ">&ndash;%&gt;--%>
                            <%--<iframe id="iframe_tab_1" name="iframe_tab_1" width="99.8%" height="100%" frameborder="no" src="">--%>
                            <%--</iframe>--%>
                        <%--</div>--%>
                        <%--<div class="tab-pane ${pd.tabs[1]}" id="tab_2" style="display: none;">--%>
                        ...
                        <%--<div class="tab-pane ${pd.tabs[3]}" id="tab_4" style="display: none;">--%>
                            ...
                            <%--</iframe>--%>
                        <%--</div>--%>
                        <%--&lt;%&ndash;<div class="tab-pane ${pd.tabs[4]}" id="tab_5">&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<iframe id="iframe_tab_5" name="alarm" width="99.8%" height="100%" frameborder="no" allowtransparency="yes" src="">&ndash;%&gt;--%>
                        <%--&lt;%&ndash;</iframe>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                        <%--<div class="tab-pane ${pd.tabs[4]}" id="tab_5" style="display: none;">--%>
                            <%--<iframe id="iframe_tab_5" name="iframe_tab_5" width="99.8%" height="100%" frameborder="no" allowtransparency="yes" src="">--%>
...
<%--<script type="text/javascript">--%>
    ...
    <%--&lt;%&ndash;var isRead="${pd.write_read}";//菜单是否只读&ndash;%&gt;--%>
    <%--&lt;%&ndash;var org_id = "${pd.org_id}";&ndash;%&gt;--%>
    <%--&lt;%&ndash;var farm_id = "${pd.farm_id}";&ndash;%&gt;--%>
    <%--&lt;%&ndash;var house_id = "${pd.house_id}";&ndash;%&gt;--%>
    <%--&lt;%&ndash;var batch_no = "${pd.batch_no}";&ndash;%&gt;--%>
    <%--&lt;%&ndash;var report_ip = "${pd.report_ip}";&ndash;%&gt;--%>
    <%--&lt;%&ndash;var report_port = "${pd.report_port}";&ndash;%&gt;--%>
    <%--var tabId = "${pd.tabId}";--%>
    <%--var searchDateTime=null;--%>
    <%--var monitorIndex = "${monitorIndex}";--%>
    <%--var reportTarIndex = "${reportTarIndex}";--%>
    <%--var extendReportParam = "${pd.extendReportParam}";--%>
<%--</script>--%>
<%--<!-- #main-content -->--%>
<%--<script type="text/javascript" src="<%=path%>/js/bootbox.min.js"></script>--%>
<%--<script type="text/javascript" src="<%=path%>/modules/analyze/js/analyzeReport.js"></script>--%>
