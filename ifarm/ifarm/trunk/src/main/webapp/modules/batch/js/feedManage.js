...
//	$.ajax({
//		url : path + "/batch/getCorporation2",
//		data : {
...
var str = '<br><div class="container-fluid" >';
	str += '<div class="row-fluid">';
	str += '<div class="span2">';
	str += '<span_customer2 >品种类别</span_customer2 >';
str += '</div>';
	str += '<div class="span4">';
	
		str += "<select id='good_type' style='width: 135px;margin-top: -3px;' tabindex='1' name='good_type' disabled = 'disabled'>";
     str+='</select>';
	str += '</div>';	
	str += '<div class="span2">';
	...
	str += '<div class="row-fluid">';
	str += '<div class="span2">';
	str += '<span_customer2 >品种名称</span_customer2 >' ;
str += '</div>';
	str += '<div class="span4" >';
...
var str = '<br><div class="container-fluid" >';
	str += '<div class="row-fluid">';
	str += '<div class="span2">';
	str += '<span_customer2 >品种类型</span_customer2 >';
    str += '</div>';
	str += '<div class="span3">';
		str += '<select id="good_type" style="width: 369px;margin-top:-3px;" tabindex="1" name="good_type" onchange="setGoodName()" disabled = "disabled">';
...
//	}
 str+='</select>';
 str+='<input type="text" id="goods_select" style="width: 354px;margin-top:-3px;" data-provide="typeahead" placeholder="请输入品种名称或编号" autocomplete="off" onchange="empty()" />';
	str += '</div>';
	str += '</div>';
...
//		}
     ...
     str+='<input type="text" id="factory_select" style="width: 354px;margin-top:-3px;" data-provide="typeahead" placeholder="请输入厂家" autocomplete="off" onchange="empty()" />';
		...
		str += '<div class="row-fluid">';
		str += '<div class="span2">';
			str += '<span_customer2 >鸡苗单价</span_customer2 >';
		str += '</div>';
			str += '<div class="span3" >';
				str += '<input type="text" style="width: 354px;margin-top:-3px;" name="price" id="price" placeholder="请输入鸡苗单价"/>' ;
			str += '</div>';	
	str += '</div>';
	str += '<div class="row-fluid">';
	str += '<div class="span2">';
		str += '<span_customer2 >毛鸡单价</span_customer2 >';
	str += '</div>';
		str += '<div class="span3" >';
			str += '<input type="text" style="width: 354px;margin-top:-3px;" name="chicken_price" id="chicken_price" placeholder="请输入毛鸡单价"/>' ;
		str += '</div>';	
str += '</div>';
		str += '<div class="row-fluid">';
		str += '<div class="span2">';
...
layer.open({
	  ...
	  if(submitForm4()){ 
		...
		$.ajax({
			url : path + "/batch/addCorporationGood",
			data : param,
			type : "POST",
			dataType : "json",
			success : function(result) {
...
function getCorporationGood(){
	...
	$.ajax({
		url : path + "/batch/getCorporationGood",
		data : param,
		type : "POST",
		dataType : "json",
		success : function(result) {
...
//		
//		$.ajax({
//			url : path + "/batch/updateCorporation",
//			data : param,
//			type : "POST",
//			dataType : "json",
//			success : function(result) {
...
str += '</div>';
	str += '<div class="span4">';
		str += '<select id="good_type" style="width: 135px;margin-top: -3px;" class="m-wrap span12" tabindex="1" name="good_type" disabled="disabled" value="'+updateRow[0].good_type+'">';
     str+='</select>';
	str += '</div>';
	str += '<div class="span2">';
	str += '<span_customer2 >品种编号</span_customer >';
str += '</div>';
	str += '<div class="span4" >';
		str += '<input type="text" style="width: 132px;margin-top: -3px;" name="good_code" id="good_code" disabled="disabled" value="'+updateRow[0].good_code+'"/>' ;
	str += '</div>';
	str += '</div>';
	str += '<div class="row-fluid">';
	str += '<div class="span2">';
	str += '<span_customer2 >品种名称</span_customer >' ;
str += '</div>';
	str += '<div class="span4" >';
...
function deletecorporationGood(){
    ...
    layer.confirm('是否确认删除？', {
    	...
    	$.ajax({
            // async: true,
            url: path+"/batch/deleteCorporationGoods",
