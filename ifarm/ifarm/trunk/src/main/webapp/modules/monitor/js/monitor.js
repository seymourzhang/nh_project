...
function formatRowStatus(value , row, index){
    ...
    if (monitorIndex.toString().indexOf("311")>-1 && ("-" == row.vent_mode_1 || -99 == row.vent_mode_1)) {
        rt = rtNotFullData;
    } else{
        if(monitorIndex.toString().indexOf("311")>-1){
            count += 1;
        }
    }
    ...
    if (monitorIndex.toString().indexOf("309")>-1 && ("-" == row.heating || -99 == row.heating)) {
        rt = rtNotFullData;
    } else{
        if(monitorIndex.toString().indexOf("309")>-1){
            count += 1;
        }
    }

    if (monitorIndex.toString().indexOf("310")>-1 && ("-" == row.refrigeration || -99 == row.refrigeration)) {
        rt = rtNotFullData;
    } else{
        if(monitorIndex.toString().indexOf("310")>-1){
            count += 1;
        }
    }
    if (monitorIndex.toString().indexOf("312")>-1 && ("-" == row.vaporization_name || -99 == row.vaporization)) {
        rt = rtNotFullData;
    } else{
        if(monitorIndex.toString().indexOf("312")>-1){
            count += 1;
        }
    }
    if (monitorIndex.toString().indexOf("911")>-1 && ("-" == row.dev_set_temp || -99 == row.dev_set_temp)) {
        rt = rtNotFullData;
    } else{
        if(monitorIndex.toString().indexOf("911")>-1){
            count += 1;
        }
    }
    if (monitorIndex.toString().indexOf("912")>-1 && ("-" == row.dev_heat_temp || -99 == row.dev_heat_temp)) {
        rt = rtNotFullData;
    } else{
        if(monitorIndex.toString().indexOf("912")>-1){
            count += 1;
        }
    }
    if (monitorIndex.toString().indexOf("913")>-1 && ("-" == row.dev_cool_temp || -99 == row.dev_cool_temp)) {
        rt = rtNotFullData;
    } else{
        if(monitorIndex.toString().indexOf("913")>-1){
            count += 1;
        }
    }
    if (monitorIndex.toString().indexOf("914")>-1 && ("-" == row.dev_set_humidity || -99 == row.dev_set_humidity)) {
        rt = rtNotFullData;
    } else{
        if(monitorIndex.toString().indexOf("914")>-1){
            count += 1;
        }
    }
    if (monitorIndex.toString().indexOf("915")>-1 && ("-" == row.dev_set_pressure || -99 == row.dev_set_pressure)) {
        rt = rtNotFullData;
    } else{
        if(monitorIndex.toString().indexOf("915")>-1){
            count += 1;
        }
    }


    if(rt.indexOf('传感器异常') >= 0){
        if(count >= row.sensor_count){
            rt = value;
        }
    }

    if("undefined" == typeof(row.batch_no) || null == row.batch_no){
...
function createTableColumns(){
    ...
    dc2.push({field: "farm_name",
        ...
        formatter: function(value,row,index){
            return '<a href="#" onclick="forwardMenu(\'z1303\',\'lm2\',\'se2\',\'op2\',\'生产监控\',\'/monitor/showMonitorBatch?farm_id=' + row.farm_id  + '&batch_no=' + ("undefined" == typeof(row.batch_no)?"":row.batch_no) +'&org_id='+row.corporation_id + '&house_type=' + row.house_type + '&tabId='+ row.M_category+ '\','+isRead+')">'+value+'</a>';
        }
    });
    // 栋舍
    dc.push({
    ...
    dc2.push({
        ...
        sortable: true,
        formatter: function(value,row,index){
            return '<a href="#" onclick="forwardMenu(\'z1303\',\'lm2\',\'se2\',\'op2\',\'生产监控\',\'/monitor/showMonitorBatch?farm_id=' + row.farm_id + '&house_id=' + row.house_id  + '&farmOrHouse=true' +'&org_id='+row.corporation_id + '&house_type=' + row.house_type + '&tabId='+ row.M_category+ '\','+isRead+')">'+value+'</a>';
        }
    });
    // 日龄
    dc.push({
    ...
    dc2.push({
        ...
        formatter: function(value,row,index){
            ...
            if (v == '正常') {
                ...
                return '<a href="#" style="color: #fff;" onclick="forwardMenu(\'z102\',\'lm2\',\'se2\',\'op2\',\'实时报警\',\'/alarmCurr/showAlarmCurr?farm_id=' + row.farm_id +'&corporation_id='+row.corporation_id +'\')">'+v+'</a>';
            }
        }
    });
        ...
        dc2.push({
            ...
            formatter: function(value,row,index){
                if (value == '-' || row.date_age =='-') {
                    return '<a href="#" style="color: #E83828;" onclick="forwardMenu(\'z103\',\'lm2\',\'se2\',\'op2\',\'报警设置\',\'/alarm/showAlarm?farm_id=' + row.farm_id + '&house_id=' + row.house_id  + '&batch_no=' + ("undefined" == typeof(row.batch_no)?"":row.batch_no) +'&tabId=0' +'&corporation_id='+row.corporation_id + '\','+isRead+')">'+'-'+'</a>';
                } else {
                    return '<a href="#" onclick="forwardMenu(\'z103\',\'lm2\',\'se2\',\'op2\',\'报警设置\',\'/alarm/showAlarm?farm_id=' + row.farm_id + '&house_id=' + row.house_id  + '&batch_no=' + ("undefined" == typeof(row.batch_no)?"":row.batch_no)  +'&tabId=0' +'&corporation_id='+row.corporation_id + '\','+isRead+')">'+value+'</a>';
                }
            }
        });
    }
    ...
    if (monitorIndex.toString().indexOf("911")>-1) {
        dc.push({
                title: '<img src="'+path +'/modules/monitor/image/dev_set_temp.png" style="width: 38px; height: 25px;" />',
                colspan: 1,
                align: 'center'
            }
        );
...
//                            },
            ...
            formatter: function(value,row,index){
                if(row.point_alarm == 0){
                    return '<a href="#" data-toggle="tooltip" data-placement="left" data-html="true" data-original-title="高报：-<br>低报：-<br>高预：-<br>低预：-\');" onclick="forwardMenu(\'z201\',\'lm2\',\'se2\',\'op2\',\'环境监测分析\',\'/surroundingsReport/showSurroundingsReport?farm_id=' + row.farm_id + '&house_id=' + row.house_id  + '&batch_no=' + ("undefined" == typeof(row.batch_no)?"":row.batch_no) +'&tabId=1' +'&org_id='+row.corporation_id +  '\')">&nbsp;'+value+'</a>';
                }
...
//                            }
    ...
    if (monitorIndex.toString().indexOf("914")>-1) {
        dc.push({
                title: '<img src="'+path +'/modules/monitor/image/dev_set_humidity.png" style="width: 38px; height: 25px;" />',
                colspan: 1,
                align: 'center'
            }
        );
        dc2.push({
            field: "dev_set_humidity",
            title: "目标湿度",
            width: '5%',
            sortable: true,
            cellStyle:function(value, row, index) {
...
//                },
            ...
            formatter: function(value,row,index){
                ...
                return colorSelect(value,'-','-',row.high_alarm_co2,row.high_co2_warning,'onclick="forwardMenu(\'z201\',\'lm2\',\'se2\',\'op2\',\'环境监测分析\',\'/surroundingsReport/showSurroundingsReport?farm_id=' + row.farm_id + '&house_id=' + row.house_id  + '&batch_no=' + ("undefined" == typeof(row.batch_no)?"":row.batch_no) +'&tabId=' + tab_id +'&org_id='+row.corporation_id +  '\')"');
//                          if (row.co2 == 0 || row.co2 == -99) {
    ...
    if (monitorIndex.toString().indexOf("308")>-1) {
        ...
        dc2.push({field: "ammonia_1",
            ...
            formatter: function(value,row,index){
                ...
                if (value == '-') {
                    return '<a href="#" style="color: #E83828;" onclick="forwardMenu(\'z201\',\'lm2\',\'se2\',\'op2\',\'环境监测分析\',\'/surroundingsReport/showSurroundingsReport?farm_id=' + row.farm_id + '&house_id=' + row.house_id  + '&batch_no=' + ("undefined" == typeof(row.batch_no)?"":row.batch_no) +'&tabId=' + tab_id +'&org_id='+row.corporation_id +  '\')">'+'-'+'</a>';
                } else {
                    return '<a href="#" onclick="forwardMenu(\'z201\',\'lm2\',\'se2\',\'op2\',\'环境监测分析\',\'/surroundingsReport/showSurroundingsReport?farm_id=' + row.farm_id + '&house_id=' + row.house_id  + '&batch_no=' + ("undefined" == typeof(row.batch_no)?"":row.batch_no) +'&tabId=' + tab_id +'&org_id='+row.corporation_id +  '\')">'+value+'</a>';
                }
            }
        });
    }
...
//                                }
    ...
    if (monitorIndex.toString().indexOf("915")>-1) {
        dc.push({
                title: '<img src="'+path +'/modules/monitor/image/dev_set_pressure.png" style="width: 38px; height: 25px;" />',
                colspan: 1,
                align: 'center'
            }
        );
        dc2.push({
            field: "dev_set_pressure",
            title: "目标负压",
            width: '5%',
            sortable: true,
            cellStyle:function(value, row, index) {
    ...
    if (monitorIndex.toString().indexOf("311")>-1) {
        dc.push({
                title: '<img src="'+path +'/modules/monitor/image/vent_mode_1.png" style="width: 38px;height: 25px;" />',
                colspan: 1,
                align: 'center'
            }
        );
        dc2.push({field: "vent_mode_1",
            title: "通风模式",
            width: '5%',
            sortable: true,
            cellStyle:function(value, row, index) {
    ...
    if (monitorIndex.toString().indexOf("309")>-1) {
        dc.push({
                title: '<img src="'+path +'/modules/monitor/image/heating.png" style="width: 38px;height: 25px;" />',
                colspan: 1,
                align: 'center'
            }
        );
        dc2.push({field: "heating",
            title: "加热",
            width: '5%',
            sortable: true,
            cellStyle:function(value, row, index) {
    ...
    if (monitorIndex.toString().indexOf("912")>-1) {
        dc.push({
                title: '<img src="'+path +'/modules/monitor/image/dev_heat_temp.png" style="width: 38px; height: 25px;" />',
                colspan: 1,
                align: 'center'
            }
        );
    ...
    if (monitorIndex.toString().indexOf("309")>-1) {
        dc.push({
                title: '<img src="'+path +'/modules/monitor/image/refrigeration.png" style="width: 38px;height: 25px;" />',
                colspan: 1,
                align: 'center'
            }
        );
        dc2.push({field: "refrigeration",
            title: "制冷",
            width: '5%',
            sortable: true,
            cellStyle:function(value, row, index) {
    ...
    if (monitorIndex.toString().indexOf("913")>-1) {
        dc.push({
                title: '<img src="'+path +'/modules/monitor/image/dev_cool_temp.png" style="width: 38px; height: 25px;" />',
                colspan: 1,
                align: 'center'
            }
        );
    ...
    if (monitorIndex.toString().indexOf("312")>-1) {
        dc.push({
                title: '<img src="'+path +'/modules/monitor/image/vaporization.png" style="width: 38px;height: 25px;" />',
                colspan: 1,
                align: 'center'
            }
        );
        dc2.push({field: "vaporization_name",
            title: "喷雾",
            width: '5%',
            sortable: true,
            cellStyle:function(value, row, index) {
    ...
    if (monitorIndex.toString().indexOf("901")>-1) {
        ...
        dc2.push({field: "collect_datetime",
            ...
            formatter: function(value,row,index){
                ...
                return '<a href="#" data-toggle="tooltip" data-placement="left" data-html="true" data-original-title="' + row.collect_date + '" onclick="forwardMenu(\'z208\',\'lm2\',\'se2\',\'op2\',\'报警统计分析\',\'/alarmHist/showAlarmHist?farm_id=' + row.farm_id + '&house_id=' + row.house_id  + '&batch_no=' + row.batch_no +'&corporation_id='+row.corporation_id + '\')">'+value+'</a>';
                // return '<a href="#" onclick="forwardMenu(\'z207\',\'lm2\',\'se2\',\'op2\',\'环境监测分析\',\'/surroundingsReport/showSurroundingsReport?farm_id=' + row.farm_id + '&house_id=' + row.house_id  + '&batch_no=' + ("undefined" == typeof(row.batch_no)?"":row.batch_no)  +'&tabId=4' +'&org_id='+row.corporation_id +  '\')">'+value+'</a>';
            }
        });
    }
...
function colorSelect(mb,db,dbWarning,gb,gbWarning,h1){
    if (mb == '-') {
        return '<a href="#" data-toggle="tooltip" data-placement="left" data-html="true" data-original-title="高报：-<br>低报：-<br>高预：-<br>低预：-" style="color: #E83828;" '+h1+ '>&nbsp;'+'-'+'</a>';
    }else if(gb == '-'){
        if(db == '-'){
            return '<a href="#" data-toggle="tooltip" data-placement="left" data-html="true" data-original-title="高报：-<br>低报：-<br>高预：-<br>低预：-" style="color: #E83828;" '+h1+'>&nbsp;'+mb+'</a>';
        }else{
            if (parseFloat(mb)<parseFloat(db)) {
                return '<a href="#" data-toggle="tooltip" data-placement="left" data-html="true" data-original-title="高报：-<br>低报：'+db+'<br>高预：-<br>低预：'+dbWarning+'" style="color: #E83828;" '+h1+'>&nbsp;'+mb+'</a>';
            }else if(parseFloat(mb)-parseFloat(db) >=0 && parseFloat(mb)-parseFloat(dbWarning) >=0){
                return '<a href="#" data-toggle="tooltip" data-placement="left" data-html="true" data-original-title="高报：-<br>低报：'+db+'<br>高预：-<br>低预：'+dbWarning+'" style="color: #f5a623;" '+h1+'>&nbsp;'+mb+'</a>';
            }
            else{
                return '<a href="#" data-toggle="tooltip" data-placement="left" data-html="true" data-original-title="高报：-<br>低报：'+db+'<br>高预：-<br>低预：'+dbWarning+'" '+h1+'>&nbsp;'+mb+'</a>';
            }
        }
    }else if(db == '-'){
        if (parseFloat(mb)>parseFloat(gb)) {
            return '<a href="#" data-toggle="tooltip" data-placement="left" data-html="true" data-original-title="高报：'+gb+'<br>低报：-<br>高预：'+gbWarning+'<br>低预：-" style="color: #E83828;" '+h1+'>&nbsp;'+mb+'</a>';
        }else if(parseFloat(gb)-parseFloat(mb) >=0 && parseFloat(gbWarning)-parseFloat(mb) <=0){
            return '<a href="#" data-toggle="tooltip" data-placement="left" data-html="true" data-original-title="高报：'+gb+'<br>低报：-<br>高预：'+gbWarning+'<br>低预：-" style="color: #f5a623;" '+h1+'>&nbsp;'+mb+'</a>';
        }
        else{
            return '<a href="#" data-toggle="tooltip" data-placement="left" data-html="true" data-original-title="高报：'+gb+'<br>低报：-<br>高预：'+gbWarning+'<br>低预：-" '+h1+'>&nbsp;'+mb+'</a>';
        }
    }
    else {
        if (parseFloat(mb)<parseFloat(db) || parseFloat(mb)>parseFloat(gb)) {
            return '<a href="#" data-toggle="tooltip" data-placement="left" data-html="true" data-original-title="高报：'+gb+'<br>低报：'+db+'<br>高预：'+gbWarning+'<br>低预：'+dbWarning+'" style="color: #E83828;" '+h1+'>&nbsp;'+mb+'</a>';
        }else if((parseFloat(mb)-parseFloat(db) >=0 && parseFloat(mb)-parseFloat(dbWarning) <=0)
            || (parseFloat(gb)-parseFloat(mb) >=0 && parseFloat(gbWarning)-parseFloat(mb) <=0)){
            return '<a href="#" data-toggle="tooltip" data-placement="left" data-html="true" data-original-title="高报：'+gb+'<br>低报：'+db+'<br>高预：'+gbWarning+'<br>低预：'+dbWarning+'" style="color: #f5a623;" '+h1+'>&nbsp;'+mb+'</a>';
        }
        else{
            return '<a href="#" data-toggle="tooltip" data-placement="left" data-html="true" data-original-title="高报：'+gb+'<br>低报：'+db+'<br>高预：'+gbWarning+'<br>低预：'+dbWarning+'" '+h1+'>&nbsp;'+mb+'</a>';
        }
    }
};
