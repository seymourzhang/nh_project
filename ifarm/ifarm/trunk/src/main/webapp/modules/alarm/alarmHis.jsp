...
var alarmHisIndex = "${alarmHisIndex}";
</script>
					...
					<div class="span12">
						<div style="padding-left: 10px;height: 40px; float:left; display:inline;">
							...
							<select id="alarm_type"  name="alarm_type" tabindex="1" style="width: 148px;display:inline;" onchange="searchData();">
								<option value="1" style="display: none;" id="at1">温度设置</option>
								<option value="2" style="display: none;" id="at2">光照设置</option>
								<option value="3" style="display: none;" id="at3">二氧化碳设置</option>
								<option value="5" style="display: none;" id="at5">湿度设置</option>
								<option value="6" style="display: none;" id="at6">负压设置</option>
								<option value="4" style="display: none;" id="at4">基础设置</option>
							</select>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
