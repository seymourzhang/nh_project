...
jQuery(document).ready(function() {
	...
	// 温度和基础
    if (alarmHisIndex.toString().indexOf("101")>-1 || alarmHisIndex.toString().indexOf("102")>-1 || alarmHisIndex.toString().indexOf("104")>-1
			|| alarmHisIndex.toString().indexOf("201")>-1 || alarmHisIndex.toString().indexOf("202")>-1 || alarmHisIndex.toString().indexOf("203")>-1
			|| alarmHisIndex.toString().indexOf("204")>-1 || alarmHisIndex.toString().indexOf("205")>-1) {
    	document.getElementById("at1").style.display = "";
    	document.getElementById("at4").style.display = "";
    }
    // 光照
    if (alarmHisIndex.toString().indexOf("303")>-1) {
    	document.getElementById("at2").style.display = "";
    }
    // 二氧化碳
    if (alarmHisIndex.toString().indexOf("302")>-1) {
    	document.getElementById("at3").style.display = "";
    }
    // 基础
//    if (alarmHisIndex.toString().indexOf("104")>-1) {
//    	document.getElementById("at4").style.display = "";
//    }
    // 湿度
    if (alarmHisIndex.toString().indexOf("301")>-1) {
    	document.getElementById("at5").style.display = "";
    }
    // 负压
    if (alarmHisIndex.toString().indexOf("304")>-1) {
    	document.getElementById("at6").style.display = "";
    }
	 // searchData();
});
...
//    	$("#BasisTable").css("display", "none");
		...
		data = [{
			...
			formatter: function(value,row,index){
				...
				return sensor
				.replace('inside_temp1', '温度1')
				.replace('inside_temp2', '温度2')
				.replace('inside_temp10', '温度3')
				.replace('inside_temp19', '温度4')
				.replace('inside_temp20', '温度5');
				}
			}
			}, {
			field: 'point_alarm',
...
InitSubTable = function (index, row, $detail) {
	...
	if(alarm_type =="1"){
		...
		data = [{
			...
			field: 'set_values',
			title: '<label style="background-color: #2586C4;color:#fff;">目标湿度</label>'
			}, {
			field: 'high_alarm_values',
			title: '<label style="background-color: #2586C4;color:#fff;">高报湿度</label>'
			}, {
			field: 'low_alarm_values',
			title: '<label style="background-color: #2586C4;color:#fff;">低报湿度</label>'
			}, {
			field: 'modify_person',
			title: '<label style="background-color: #2586C4;color:#fff;">设置人</label>'
			}];
		...
		data = [{
			...
			field: 'set_values',
			title: '<label style="background-color: #2586C4;color:#fff;">目标负压</label>'
			}, {
			field: 'high_alarm_values',
			title: '<label style="background-color: #2586C4;color:#fff;">高报负压</label>'
			}, {
			field: 'low_alarm_values',
			title: '<label style="background-color: #2586C4;color:#fff;">低报负压</label>'
			}, {
			field: 'modify_person',
			title: '<label style="background-color: #2586C4;color:#fff;">设置人</label>'
			}];
...
function alarmType(){
	...
	if(alarm_type =="1"){
		...
		document.getElementById("HumidityFrame").style.display="none";
		document.getElementById("NegativePressure2Frame").style.display="none";
		...
		document.getElementById("CarbonFrame").style.display="none";
		document.getElementById("NegativePressureFrame").style.display="none";
		document.getElementById("HumidityFrame").style.display="";
		document.getElementById("NegativePressure2Frame").style.display="none";
		document.getElementById("BasisFrame").style.display="none";
	}else if(alarm_type =="6"){
		document.getElementById("TemperatureCurveFrame").style.display="none";
		...
		document.getElementById("NegativePressureFrame").style.display="none";
		document.getElementById("HumidityFrame").style.display="none";
		document.getElementById("NegativePressure2Frame").style.display="";
		document.getElementById("BasisFrame").style.display="none";
	}else{
		document.getElementById("TemperatureCurveFrame").style.display="none";
		document.getElementById("CarbonFrame").style.display="none";
