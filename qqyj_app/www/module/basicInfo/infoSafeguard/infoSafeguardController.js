...
.controller("infoSafeguardCtrl",function($scope, $state, $http, $ionicPopup, $ionicModal,AppData) {
	...
	$scope.goDeviceTable = function(){
		biz_common_judgeRegistInfo($ionicPopup,$state,"deviceTable");
	}
    ...
    $scope.alarmChanger = function(){
		...
		Sparraw.ajaxPost('autioSettingMobile/setMobileAlarm', params, function(data){
			if (data.ResponseDetail.Result == "Success") {
