DROP FUNCTION IF EXISTS sparrow.s_f_getDayAgeByHouseBreedId;
CREATE DEFINER=`phoe`@`%` FUNCTION `s_f_getDayAgeByHouseBreedId`(in_house_breed_id int,in_date DATETIME) RETURNS int(11)
BEGIN
