...
.controller("homeCtrl",function($scope, $state, $http, $ionicPopup,$ionicLoading,$cordovaFileTransfer,$cordovaFileOpener2,$timeout,AppData) {
	...
	$scope.goTabIndex = function(){
		biz_common_judgeRegistInfo($ionicPopup,$state,"tabIndex");
	};

	$scope.goCommunity = function(){
		$scope.showUrl = 'http://www.vzan.com/f/s-875034';
		cordova.ThemeableBrowser.open($scope.showUrl, '_blank', {
		    ...
		    closeButton: {
                  wwwImage: 'img/newFolder/public/cross.png',
                  wwwImagePressed: 'img/newFolder/public/cross.png',
                  wwwImageDensity: 3,
                  align: 'right',
                  event: 'closePressed'
              },
