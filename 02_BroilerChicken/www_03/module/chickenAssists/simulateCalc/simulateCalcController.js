...
.controller("simulateCalcCtrl",function($scope, $state,$ionicModal,$ionicLoading) {
	...
	$scope.selectPlanStyle = function(planType){
		$scope.selectGuige();
		if (planType == 'plan1') {
			document.getElementById('plan1').style.borderBottom = "thick solid #44CA65";
			document.getElementById('plan1Test').style.color = "#44CA65";
			document.getElementById('plan2').style.borderBottom = "thick solid #666";
			document.getElementById('plan2Test').style.color = "#666";
		}else{
			document.getElementById('plan2').style.borderBottom = "thick solid #44CA65";
			document.getElementById('plan2Test').style.color = "#44CA65";
			document.getElementById('plan1').style.borderBottom = "thick solid #666";
			document.getElementById('plan1Test').style.color = "#666";
		}
	}
