...
.controller("weeklyCtrl",function($scope, $state, $http,$ionicModal, $stateParams, $ionicPopup, AppData) {
	...
	if (DeviInfo.ScreenHeight > DeviInfo.ScreenWidth) {
		document.getElementById('weekly_DIV').style.height = (DeviInfo.ScreenHeight - 100) + 'px';
	}else{
		document.getElementById('weekly_DIV').style.height = (DeviInfo.ScreenWidth - 100) + 'px';
	}
