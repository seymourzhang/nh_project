...
.state('passwordModify', {
      url:'/passwordModify/:employeesID',
      cache:false,
...
.state('warnTabIndex', {//warnCount
    url: '/warnTabIndex',
    cache:false,
    templateUrl: 'module/envMonitor/warnCount/warnTabIndex.html',
...
.state('warnTabIndex.envWarnChart', {
    ...
    views: {
      'warnTabIndex-envWarnChart': {
        templateUrl: 'module/envMonitor/warnCount/envWarnChart/warnTabIndex-envWarnChart.html',
...
.state('warnTabIndex.warnStatistics', {
    ...
    views: {
      'warnTabIndex-warnStatistics': {
        templateUrl: 'module/envMonitor/warnCount/warnStatistics/warnTabIndex-warnStatistics.html',
...
//二氧化碳
.state('envAnalyIndex.CO2', {
    url: '/CO2',
    cache:false,
    views: {
      'envAnalyIndex-CO2': {
        templateUrl: 'module/envAnalysis/CO2/envAnalyIndex-CO2.html',
        controller: 'CO2Ctrl'
      }
    }
  })
//光照
.state('envAnalyIndex.light', {
    url: '/light',
    cache:false,
    views: {
      'envAnalyIndex-light': {
        templateUrl: 'module/envAnalysis/light/envAnalyIndex-light.html',
        controller: 'lightCtrl'
      }
    }
  })
//报警次数
.state('envAnalyIndex.alerts', {
    url: '/alerts',
    cache:false,
    views: {
      'envAnalyIndex-alerts': {
        templateUrl: 'module/envAnalysis/alerts/envAnalyIndex-alerts.html',
...
//指标分析
  .state('tabIndex', {
    url: '/tabIndex',
    cache:false,
    templateUrl: 'module/reportCurve/tabIndex.html',
    controller: 'tabIndexCtrl'
  })
//成活率
.state('tabIndex.survival', {
    url: '/survival',
    cache:false,
    views: {
      'tabIndex-survival': {
        templateUrl: 'module/reportCurve/survival/tabIndex-survival.html',
        controller: 'survivalCtrl'
      }
    }
  })
//日死淘率
.state('tabIndex.dayCullDeath', {
    url: '/dayCullDeath',
    cache:false,
    views: {
      'tabIndex-dayCullDeath': {
        templateUrl: 'module/reportCurve/dayCullDeath/tabIndex-dayCullDeath.html',
        controller: 'dayCullDeathCtrl'
      }
    }
  })
//日采食率
.state('tabIndex.dayFoodCurve', {
    url: '/dayFoodCurve',
    cache:false,
    views: {
      'tabIndex-dayFoodCurve': {
        templateUrl: 'module/reportCurve/dayFoodCurve/tabIndex-dayFoodCurve.html',
        controller: 'dayFoodCurveCtrl'
      }
    }
  })
//日饮水率
.state('tabIndex.dayWaterCurve', {
    url: '/dayWaterCurve',
    cache:false,
    views: {
      'tabIndex-dayWaterCurve': {
        templateUrl: 'module/reportCurve/dayWaterCurve/tabIndex-dayWaterCurve.html',
        controller: 'dayWaterCurveCtrl'
      }
    }
  })
// 周体重
.state('tabIndex.weekWeight', {
    url: '/weekWeight',
    cache:false,
    views: {
      'tabIndex-weekWeight': {
        templateUrl: 'module/reportCurve/weekWeight/tabIndex-weekWeight.html',
        controller: 'weekWeightCtrl'
      }
    }
  })
//水料比
.state('tabIndex.waterFeed', {
    url: '/waterFeed',
    cache:false,
    views: {
      'tabIndex-waterFeed': {
        templateUrl: 'module/reportCurve/waterFeed/tabIndex-waterFeed.html',
