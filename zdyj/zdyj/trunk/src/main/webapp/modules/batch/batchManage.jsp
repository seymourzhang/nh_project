...
<!-- 										<button type="button" class="btn blue" style="text-align: left;vertical-align: middle;" onclick="downLoad();" id="addData"> -->
																<a class="btn blue" href=download><i class="icon-arrow-down">&nbsp;文件模板下</i></a>
<!-- 															</button> -->
                                        </div>
...
<!--                                             <div class="span3" align="left"> -->
                                            ...
                                            <span_customer2>数量</span_customer2>
                                                ...
                                                <input id="overBatchFemaleAvgWeight2" type="text" value="0" style="width:36px;">&nbsp;g
                                            </div>
                                            </div>
...
<!--                                     </div> -->
                                        ...
                                        <p align="center"  style="font-weight:bold;">新增</p></button>
                                </div>
                                </div>
                            </div>
                        </div>
