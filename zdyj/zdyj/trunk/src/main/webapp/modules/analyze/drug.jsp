            ...
            <div class="tabbable tabbable-custom boxless">
                ...
                <div class="tab-content" style="border:none;background:#e7e5e5;padding-top: 0px;">
                    <div class="tab-pane active" id="tab_1">
                        ...
                        <iframe id="iframe_tab_1" name="inStockForm" width="99.8%" height="720px" frameborder="no" allowtransparency="yes" src="">
                        </iframe>
                    </div>


                    <div class="tab-pane" id="tab_2">
                        <iframe id="iframe_tab_2" name="inStockForm" width="99.8%" height="720px" frameborder="no" allowtransparency="yes" src="">
                        </iframe>
                    </div>
