...
本文件属于配置文件
*/
// 以下变量定义了app登录的方式是否走公共平台，Public-公共 Private-私有
var CONFIG_LogInMode = 'Private';

// CONFIG_AppMode 配置服务端采用生产、测试、本地   'Production' 'Development' 'Local'
var CONFIG_AppMode = 'Production';

// App的版本号
var CONFIG_App_Version = '1.2.1';

// 生产服务器地址
var CONFIG_Production_API_Host = 'https://cp-z.agnet.com.cn/zdyz/';
// 测试服务器地址
var CONFIG_Development_API_Host = 'http://192.168.10.66:8080/zdyz/';
// 本地服务器地址
var CONFIG_Local_API_Host = 'http://192.168.10.244:8086/zdyz/';
// var CONFIG_Local_API_Host = 'http://192.168.10.227:8081/ifarm/';

// apk更新地址
var apkUpdateHost = 'http://data.agnet.com.cn:8888/sync/';

// APK名称前缀
var CONFIG_apkNamePrefix = 'nht_qyyz_pro';
...
var persistentData = {
  ...
  'transferUserArr'       :  [],
  'selectedUserInfo'      :  '',
  'tabHeight':30,//tab页面内容的高度
  'verticalTime':2000,//垂直旋转时间
  'horizontalTime':2000//水平旋转时间
};
