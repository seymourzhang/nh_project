...
.controller('weekCtrl', function($scope, $state) {
	...
	if(Common_isIOS()){
        document.getElementById("weekTable").style.height = "85%";
        document.getElementById("houseTable").style.top = "85%";
    }else{
        document.getElementById("weekTable").style.height = "76%";
	...
	$scope.initData = function(){
		...
		$scope.chooseHouse($scope.weeklyData.selectHouseId);
    }; 
	...
	$scope.chooseHouse = function(item){
		...
		$scope.weeklyData.selectHouseId = item;
		$scope.inquire();
	}
