...
/**
 * @ClassName: CRC16_Modbus
 * @Description: 
 * @Date 2015年12月9日 下午5:28:25
...
public class CRC16_Modbus {
	...
	public static byte[] getSendBuf(String toSend){   
		...
		CRC16_Modbus crc16 = new CRC16_Modbus();   
	...
	public static void main(String[] args) {
		String sourceStr = "7B3A297D000100100000000000000000" ;
//		sourceStr = "7b3A297d840100241f2600630001000003e90003000141ae666603e90003000242560000";
		System.out.println(sourceStr.length());
		byte[] sbuf = CRC16_Modbus.getSendBuf(sourceStr);   
	}
}
